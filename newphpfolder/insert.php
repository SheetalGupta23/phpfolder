	...
	if($database->connect_error){
		...
		$cand_mail=$_POST["email"];
		$cand_pass=md5($_POST["password"]);

		if($method=="POST"){
			$data="INSERT INTO login_details(USERNAME,EMAIL,PASSWORD)VALUES(
			'$cand_name','$cand_mail','$cand_pass'
		)";
		$database->query($data);
		}
		else{
		...
		<div class="cards">
			...
			<div class="card-body">
				<form action="insert.php" method="post">
					...
					<input type="password" name="password" placeholder="Enter password" class="form-control mb-2"><br>
